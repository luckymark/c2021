...
#define DEBUG(x) for(int i=0;i<x.size();++i)fprintf(fp,"(%d,%d)\n",x[i].second.first,x[i].second.second);fputs("-----------\n",fp);
...
void GeneratePoint(vector<pair<int,pair<int,int> > > &Ans,const bool &Color,const int &Limit,const bool &flag){
    ...
    //     fputs("Four[0]\n",fp);DEBUG(Four[0]);
    //     fputs("Four[1]\n",fp);DEBUG(Four[1]);
    //     fputs("BlockedFour[0]\n",fp);DEBUG(BlockedFour[0]);
    //     fputs("BlockedFour[1]\n",fp);DEBUG(BlockedFour[1]);
    //     fputs("TwoThree[0]\n",fp);DEBUG(TwoThree[0]);
    //     fputs("TwoThree[1]\n",fp);DEBUG(TwoThree[1]);
    //     fputs("Three[0]\n",fp);DEBUG(Three[0]);
    //     fputs("Three[1]\n",fp);DEBUG(Three[1]);
